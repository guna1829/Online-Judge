...
function Dashboard({ userRole, isAuthenticated }) {
    ...
    const fetchDashboardData = async () => {
        ...
        try {
            ...
            // Fetch user stats
            const statsResponse = await axios.get(`${USER_API_BASE_URL}/${currentUser._id}/stats`, {
                ...config,
            ...
            const recentSubmissionsResponse = await axios.get(`${USER_API_BASE_URL}/${currentUser._id}/recent-submissions`, {
                ...config,
                headers: { ...config.headers, 'Cache-Control': 'no-cache' }
            });
            ...
            // Fetch user activity
            const activityResponse = await axios.get(`${USER_API_BASE_URL}/${currentUser._id}/activity`, {
                ...config,
                headers: { ...config.headers, 'Cache-Control': 'no-cache' }
            });
